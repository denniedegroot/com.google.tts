 ...
 * @return {GoogleHomeAudioTTS}
 */
GoogleHomeAudioTTS.prototype.getTtsUrl = function(message) {
    return googletts(message, this.language, this.ttsSpeed, this.ttsTimeout);
};
...
GoogleHomeAudioTTS.prototype.tts = function(message, callback) {
    this.getTtsUrl(message).then((url) => {
